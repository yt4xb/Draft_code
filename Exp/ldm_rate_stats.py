...
def main(logfile, jsonfile, feedtype):
	...
	Args:
		...
		jsonfile : Filename of the new file to contain output results.
	"""
	...
	data = {"IFACE_NAME": "eth", "TC_RATE" : '20', "TC_BUFFER" : '600m'}
